...
function clickElementBySelector(selector, callback) {
    ...
    if (element) {
        ...
        element.click();
        if (callback) {
            callback(true); // Element clicked successfully
        }
    } else {
                                                        ...
                                                        clickElementBySelector("#radix-\\:rf\\: > div.flex.flex-col.items-center.justify-center.text-center > button", function() {
                                                            setTimeout(function() {
                                                                clickElementBySelector("#root > div > div.px-4 > div.mx-auto.space-y-4 > div:nth-child(4) > div.relative.z-10.flex.items-center.justify-between.gap-2 > button", function() {
                                                                    setTimeout(function() {
                                                                        clickElementBySelector("#radix-\\:rf\\: > div.flex.flex-col.items-center.justify-center.text-center > button", function(clicked) {
                                                                            if (clicked) {
                                                                                // Proceed with the additional steps
                                                                                clickElementBySelector("#root > div > div.px-4 > button > img", function(clicked) {
                                                                                    if (clicked) {
                                                                                        setTimeout(function() {
                                                                                            clickElementBySelector("#radix-\\:ra\\: > div.flex.flex-col.items-center.justify-center.p-4.pb-12.text-center > button", function(clicked) {
                                                                                                if (clicked) {
                                                                                                    setTimeout(function() {
                                                                                                        clickElementBySelector("#root > div > div.relative.h-12.w-full.grow.border-t.border-\\[\\#0A4E7B\\].bg-\\[\\#0D0D15\\] > button", function(clicked) {
                                                                                                            if (clicked) {
                                                                                                                setTimeout(function() {
													                    ...
													                    setTimeout(function() {
													                        window.location.href = "https://rocketf.whitechain.io/";
                                                                                        ...
                                                                                        // If element not found, proceed with alternative sequence
                                                                                        alternativeClickSequence();
                                                                                    }
                                                                                });
                                                                            } else {
                                                                                // If element not found, proceed with alternative sequence
...
function alternativeClickSequence() {
    setTimeout(function() {
        clickElementBySelector("#root > div > div.px-4 > div.pointer-events-auto.grid.h-\\[52px\\].grid-cols-2.items-center.gap-2.mb-6 > button:nth-child(1)", function(clicked) {
            if (clicked) {
                setTimeout(function() {
                    clickElementBySelector("#radix-\\:r1\\: > div.flex.flex-col.items-center.justify-center.p-4.pb-12.text-center > button", function(clicked) {
                        if (clicked) {
	                    setTimeout(function() {
	                        window.location.href = "https://rocketf.whitechain.io/";
	                    }, 10000);
        ...
        setTimeout(function() {
            clickElementBySelector("#radix-\\:r7\\: > div.flex.flex-col.items-center.justify-center.p-4.pb-12.text-center > button", function(clicked) {
                if (clicked) {
                    setTimeout(function() {
                        window.location.href = "https://rocketf.whitechain.io/";
                    }, 10000);
        ...
        setTimeout(function() {
            clickElementBySelector("#radix-\\:r4\\: > div.flex.flex-col.items-center.justify-center.p-4.pb-12.text-center > button", function(clicked) {
                if (clicked) {
                    setTimeout(function() {
                        window.location.href = "https://rocketf.whitechain.io/";
                    }, 10000);
        ...
        setTimeout(function() {
            clickElementBySelector("#radix-\\:ru\\: > div.flex.flex-col.items-center.justify-center.p-4.pb-12.text-center > button", function(clicked) {
                if (clicked) {
                    setTimeout(function() {
                        window.location.href = "https://rocketf.whitechain.io/";
                    }, 10000);
        ...
        setTimeout(function() {
            clickElementBySelector("#radix-\\:ro\\: > div.flex.flex-col.items-center.justify-center.p-4.pb-12.text-center > button", function(clicked) {
                if (clicked) {
                    setTimeout(function() {
                        window.location.href = "https://rocketf.whitechain.io/";
                    }, 10000);
        ...
        setTimeout(function() {
            clickElementBySelector("#radix-\\:r1o\\: > div.flex.flex-col.items-center.justify-center.p-4.pb-12.text-center > button", function(clicked) {
                if (clicked) {
                    setTimeout(function() {
                        window.location.href = "https://rocketf.whitechain.io/";
                    }, 10000);
